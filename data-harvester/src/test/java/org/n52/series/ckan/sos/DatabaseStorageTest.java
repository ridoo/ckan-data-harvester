...
public class DatabaseStorageTest extends HibernateTestCase {
    ...
    public void setUp() throws IOException, URISyntaxException {
        ...
        service = new FileBasedCkanHarvestingService(testFolder.getRoot(), dataFolder);
        sosDataStore = new SosDataStoreManager();
...
//    @Ignore("work in progress")
    ...
    private void insertDataset(String datasetId) {
        try {
            InMemoryDataStoreManager inMemoryStore = service.getCkanDataStoreManager();
            sosDataStore.insertOrUpdate(inMemoryStore.getCollection(datasetId));
        } catch (Exception e) {
